				...
				<div class="card-body">
					<form action="${root}board/read" method="get">
						...
						<div class="form-group">
							...
							<input type="text" id="board_subject" name="board_subject" class="form-control" value="${readContentBean.content_subject}"/>
						</div>
						<div class="form-group">
							<label for="board_content">내용</label>
							<textarea id="board_content" name="board_content" class="form-control" rows="10" style="resize:none">${readContentBean.content_text}</textarea>
						</div>
						<div class="form-group">
							<label for="board_file">첨부 이미지</label>
							<img src="${root}image/medus.jpg" width="100%"/>	
